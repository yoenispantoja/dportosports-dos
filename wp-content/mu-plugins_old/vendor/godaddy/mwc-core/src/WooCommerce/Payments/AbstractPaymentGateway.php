...
abstract class AbstractPaymentGateway extends WC_Payment_Gateway
{
    ...
    protected function buildTransactionForOrder(string $transactionType, WC_Order $wooOrder) : AbstractTransaction
    {
        ...
        // Generate idempotency key for the transaction
        $transaction->setIdempotencyKey($this->generateIdempotencyKey());
     ...
     *
     * Default implementation uses UUID v4. Gateways can override if needed.
     *
     * @return string
     */
