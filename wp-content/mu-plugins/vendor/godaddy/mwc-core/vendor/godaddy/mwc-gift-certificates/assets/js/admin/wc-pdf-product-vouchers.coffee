					...
					<form method="get" action="' + url + '">
						...
						<p>
							<label>' + pdf_vouchers.i18n.amount_label + '
								<input type="text" name="amount" class="large-text js-wc-pdf-vouchers-redeem-amount" value="' + window.accounting.unformat( remaining_value, woocommerce_admin.mon_decimal_point ) + '" />
							</label>
						</p>
						<p>
