 ...
 */
function newsmunch_sanitize_hex_color( $hex_color, $setting ) {
 ...
 */
function newsmunch_sanitize_image( $image, $setting ) {
 ...
 */
function newsmunch_sanitize_nohtml( $nohtml ) {
 ...
 */
function newsmunch_sanitize_number_absint( $number, $setting ) {
...
function newsmunch_sanitize_sortable( $val, $setting ) {
...
function newsmunch_sanitize_typography_fonts( $input ) {
	$standard = newsmunch_font_selector_get_standard_fonts();
	$google = newsmunch_font_selector_get_google_fonts_array();
