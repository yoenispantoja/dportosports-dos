		...
		<div class="dt-col-lg-12 content-right">
			...
			<?php endif; ?>
					<?php global $post;
						...
						<?php	
							elseif($newsmunch_archives_post_layout=='list'):
								get_template_part('template-parts/content/content','page-list'); 
							elseif($newsmunch_archives_post_layout=='minimal'):
								get_template_part('template-parts/content/content','page-minimal');	
							elseif($newsmunch_archives_post_layout=='classic'):
								get_template_part('template-parts/content/content','page-classic');	
							endif;	
						?>
