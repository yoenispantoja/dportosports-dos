...
{
    /** @var bool */
    private static bool $grabbingTemplateOverrides = false;
    ...
    {
        return self::$grabbingTemplateOverrides;
    }
    ...
    public static function getTemplateOverrides() : array
    {
        ...
        self::$grabbingTemplateOverrides = true;

        $report = RestApiRepository::getSystemStatus();

        self::$grabbingTemplateOverrides = false;
