...
$newsmunch_pg_404_subttl		= get_theme_mod('newsmunch_pg_404_subttl','<i class="fas fa-4" aria-hidden="true"></i> <i class="fas fa-question" aria-hidden="true"></i> <i class="fas fa-4" aria-hidden="true"></i>');
$newsmunch_pg_404_subttl2		= get_theme_mod('newsmunch_pg_404_subttl2',"Oops! That page can't be found.");
$newsmunch_pg_404_text		= get_theme_mod('newsmunch_pg_404_text','Unfortunately, something went wrong and this page does not exist. Try using click the button and return to the previous page.');
			...
			<div class="dt-col-xl-7 dt-col-lg-8 dt-col-md-9 dt-col-12 dt-mx-auto dt-mb-6">
				<div class="dt_siteheading dt-text-center">
					...
					<div class="dt_siteheading_box">
						<?php if ( ! empty($newsmunch_pg_404_subttl) ) : ?>	
							<h2 class="title">
								<?php echo wp_kses_post($newsmunch_pg_404_subttl); ?>
							</h2>
						<?php endif; ?> 
						...
						<?php if ( ! empty($newsmunch_pg_404_text) ) : ?>	
							<div class="text dt-mt-3 wow fadeInUp" data-wow-duration="1500ms">
								<p><?php echo wp_kses_post($newsmunch_pg_404_text); ?></p>
							</div>
						<?php endif; ?> 
