...
class WC_URL_Coupons extends Framework\SV_WC_Plugin {
	...
	public function get_documentation_url() {
		/**
		 * Filters the plugin documentation URL.
		 *
		 * @since 2.16.1
		 *
		 * @param string $url The plugin documentation URL.
		 */
		return (string) apply_filters( 'wc_url_coupons_documentation_url', 'https://docs.woocommerce.com/document/url-coupons/' );
	}
