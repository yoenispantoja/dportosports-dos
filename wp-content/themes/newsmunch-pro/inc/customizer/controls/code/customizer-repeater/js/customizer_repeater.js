...
jQuery(document).ready(function () {
    ...
    newsmunch_theme_controls.on('click', '.customizer-repeater-new-field', function () {
        ...
        // {
        // if(jQuery('#exist_newsmunch_Slider').val()>=3)
        // {
        ...
        // }
         // if(jQuery('#exist_newsmunch_Slider').val()<3)
        // {
         // var new_service_add_val=parseInt(jQuery('#exist_newsmunch_Slider').val())+1;
         // jQuery('#exist_newsmunch_Slider').val(new_service_add_val);  
        // }
        // }
		
		 // if(split_add_more_button_split=="Add New Serv")
        // {
        // if(jQuery('#exist_newsmunch_Service').val()>=4)
        // {
        ...
        // }
         // if(jQuery('#exist_newsmunch_Service').val()<4)
        // {
         // var new_service_add_val=parseInt(jQuery('#exist_newsmunch_Service').val())+1;
         // jQuery('#exist_newsmunch_Service').val(new_service_add_val);  
        // }
        // }
         // if(split_add_more_button_split=="Add New Test")
        // {
        // if(jQuery('#exist_newsmunch_Testimonial').val()>=3)
        // {
        ...
        // }
         // if(jQuery('#exist_newsmunch_Testimonial').val()<3)
        // {
         // var new_service_add_val=parseInt(jQuery('#exist_newsmunch_Testimonial').val())+1;
         // jQuery('#exist_newsmunch_Testimonial').val(new_service_add_val);  
        // }
        // }
    ...
    newsmunch_theme_controls.on('click', '.social-repeater-general-control-remove-field', function () {
        ...
        if (typeof    jQuery(this).parent() !== 'undefined') {
            jQuery(this).parent().hide(500, function(){
                ...
                // {
                // jQuery('#exist_newsmunch_Slider').val(parseInt(jQuery('#exist_newsmunch_Slider').val())-1);  
                // }
				// if(split_delete_button_split=="Delete Servi")
                // {
                // jQuery('#exist_newsmunch_Service').val(parseInt(jQuery('#exist_newsmunch_Service').val())-1);  
                // }
				// if(split_delete_button_split=="Delete Testi")
                // {
                // jQuery('#exist_newsmunch_Testimonial').val(parseInt(jQuery('#exist_newsmunch_Testimonial').val())-1); 
                // }
            });
        }
        return false;
