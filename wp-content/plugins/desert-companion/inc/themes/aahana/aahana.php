...
require desert_companion_plugin_dir . 'inc/themes/aahana/front/site-header.php';
...
if ( ! function_exists( 'desert_companion_cosmobit_frontpage_sections' ) ) :
	function desert_companion_cosmobit_frontpage_sections() {	
		require desert_companion_plugin_dir . 'inc/themes/aahana/front/section-slider.php';
		require desert_companion_plugin_dir . 'inc/themes/aahana/front/section-information.php';
