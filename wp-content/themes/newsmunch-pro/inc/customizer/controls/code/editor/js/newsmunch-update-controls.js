            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if(result !== '' && result !== 'undefined' ){
                        ...
                        jQuery( '#NewsMunch_Page_Editor' ).val(content);
                        WPEditorWidget.setEditorContent('NewsMunch_Page_Editor');
                        ...
                        if(result.post_thumbnail !== '' && result.post_thumbnail !== 'undefined'){
                            ...
                            var html = '<label for="newsmunch_feature_thumbnail-button">' +
                                ...
                                '<button type="button" class="button upload-button control-focus" id="newsmunch_feature_thumbnail-button">Change Image</button> ' +
