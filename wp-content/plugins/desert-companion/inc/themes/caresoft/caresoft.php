...
if ( ! function_exists( 'desert_companion_softme_frontpage_sections' ) ) :
	function desert_companion_softme_frontpage_sections() {	
		require desert_companion_plugin_dir . 'inc/themes/caresoft/front/section-slider.php';
		require desert_companion_plugin_dir . 'inc/themes/caresoft/front/section-information.php';
