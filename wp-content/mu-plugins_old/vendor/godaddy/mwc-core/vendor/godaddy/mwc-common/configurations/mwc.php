...
return [
    ...
    'extensions' => [
        ...
        'api' => [
            'url' => [
                'dev'  => defined('MWC_EXTENSIONS_API_URL') ? MWC_EXTENSIONS_API_URL : 'https://api-test.mwc.secureserver.net/v1',
                'prod' => defined('MWC_EXTENSIONS_API_URL') ? MWC_EXTENSIONS_API_URL : 'https://api.mwc.secureserver.net/v1',
            ],
            'settings' => [
                'reseller' => [
