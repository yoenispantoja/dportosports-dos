...
if ( ! function_exists( 'desert_companion_softme_frontpage_sections' ) ) :
	function desert_companion_softme_frontpage_sections() {	
		require desert_companion_plugin_dir . 'inc/themes/easytech/front/section-slider.php';
		require desert_companion_plugin_dir . 'inc/themes/easytech/front/section-information.php';
...
/*=========================================
EasyTech Site Header
=========================================*/
if ( ! function_exists( 'easytech_site_header' ) ) :
function easytech_site_header() {
...
add_action( 'easytech_site_header', 'easytech_site_header' );