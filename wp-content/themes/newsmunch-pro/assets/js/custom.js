...
jQuery(document).ready(function ($) {
    ...
    /* url Push */
    var dt_url_pushes,dt_pushes_up,dt_pushes_down,push_obj,last_up,last_down;($(".dt-infinite-scroll").length||$(".dt-load-more").length)&&(dt_url_pushes=[],dt_pushes_down=dt_pushes_up=0,push_obj={prev:window.location.href,next:"",offset:$(window).scrollTop(),prev_title:window.document.title,next_title:window.document.title},dt_url_pushes.push(push_obj),window.history.pushState(push_obj,"",window.location.href),last_down=0,$(window).scroll((function(){dt_url_pushes[dt_pushes_up].offset!=last_up&&$(window).scrollTop()<dt_url_pushes[dt_pushes_up].offset&&(last_up=dt_url_pushes[dt_pushes_up].offset,last_down=0,window.document.title=dt_url_pushes[dt_pushes_up].prev_title,window.history.replaceState(dt_url_pushes,"",dt_url_pushes[dt_pushes_up].prev),0!==dt_pushes_down&&dt_pushes_up--),dt_url_pushes[dt_pushes_down].offset!=last_down&&$(window).scrollTop()>dt_url_pushes[dt_pushes_down].offset&&(last_down=dt_url_pushes[dt_pushes_down].offset,last_up=0,window.document.title=dt_url_pushes[dt_pushes_down].next_title,window.history.replaceState(dt_url_pushes,"",dt_url_pushes[dt_pushes_down].next),dt_pushes_up<dt_url_pushes.length-1&&(dt_pushes_up=dt_pushes_down,dt_pushes_down++))})));var dt_load_ajax_new_count=0;$(document).on("click",".dt-load-more a",(function(t){t.preventDefault();var s=window.location.href,e=window.document.title,o=$(this),d=o.attr("href");o.addClass("dt-loader-active"),$(".dt-loader").show(),$("<div>").load(d,(function(){var t=dt_load_ajax_new_count.toString(),n=o.closest(".dt-posts-module").find(".dt-posts"),l=$(this).find(".dt-posts-module:last .dt-posts > article").addClass("dt-posts-new-"+t),i=$(this);l.imagesLoaded((function(){if(l.hide().appendTo(n).fadeIn(400),i.find(".dt-load-more").length?($(".dt-load-more").html(i.find(".dt-load-more").html()),$(".dt-loader").hide(),o.removeClass("dt-loader-active")):$(".dt-load-more").fadeOut("fast").remove(),d!=window.location.href){dt_pushes_up++,dt_pushes_down++;var t=i.find("title").text(),_={prev:s,next:d,offset:$(window).scrollTop(),prev_title:e,next_title:t};dt_url_pushes.push(_),window.document.title=t,window.history.pushState(_,"",d),$(".post button.toggle-button").each((function(){$(this).on("click",(function(t){$(this).next(".social-share:not(.single-post-share) .icons").toggleClass("visible"),$(this).toggleClass("fa-close").toggleClass("fa-share-nodes")}))}))}return dt_load_ajax_new_count++,!1}))}))}));var dt_infinite_allow=!0;$(".dt-infinite-scroll").length&&$(window).scroll((function(){if(dt_infinite_allow&&$(".dt-infinite-scroll").length&&$(this).scrollTop()>$(".dt-infinite-scroll").offset().top-$(this).height()-200){var t=$(".dt-infinite-scroll a"),s=t.attr("href"),e=window.location.href,o=window.document.title;null!=s&&(dt_infinite_allow=!1,$(".dt-loader").show(),$("<div>").load(s,(function(){var d=dt_load_ajax_new_count.toString(),n=t.closest(".dt-posts-module").find(".dt-posts"),l=$(this).find(".dt-posts-module:last .dt-posts > article").addClass("dt-posts-new-"+d),i=$(this);l.imagesLoaded((function(){if(l.hide().appendTo(n).fadeIn(400),i.find(".dt-infinite-scroll").length?($(".dt-infinite-scroll").html(i.find(".dt-infinite-scroll").html()),$(".dt-loader").hide(),dt_infinite_allow=!0):$(".dt-infinite-scroll").fadeOut("fast").remove(),s!=window.location.href){dt_pushes_up++,dt_pushes_down++;var t=i.find("title").text(),d={prev:e,next:s,offset:$(window).scrollTop(),prev_title:o,next_title:t};dt_url_pushes.push(d),window.document.title=t,window.history.pushState(d,"",s),$(".post button.toggle-button").each((function(){$(this).on("click",(function(t){$(this).next(".social-share:not(.single-post-share) .icons").toggleClass("visible"),$(this).toggleClass("fa-close").toggleClass("fa-share-nodes")}))}))}return dt_load_ajax_new_count++,!1}))})))}}));
