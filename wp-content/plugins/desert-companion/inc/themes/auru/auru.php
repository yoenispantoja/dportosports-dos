...
require desert_companion_plugin_dir . 'inc/themes/auru/customizer-repeater-default.php';
 ...
 * Remove Options
 */
function desert_companion_auru_remove_options( $wp_customize ) {
...
add_action( 'customize_register', 'desert_companion_auru_remove_options',99 );
...
if ( ! function_exists( 'desert_companion_cosmobit_frontpage_sections' ) ) :
	function desert_companion_cosmobit_frontpage_sections() {	
	    ...
	    require desert_companion_plugin_dir . 'inc/themes/auru/front/section-information.php';
