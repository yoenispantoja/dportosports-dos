...
require desert_companion_plugin_dir . 'inc/themes/thinity/customizer/cosmobit-information-section.php';
...
if ( ! function_exists( 'desert_companion_cosmobit_frontpage_sections' ) ) :
	function desert_companion_cosmobit_frontpage_sections() {	
		require desert_companion_plugin_dir . 'inc/themes/arvana/front/section-slider.php';
	    require desert_companion_plugin_dir . 'inc/themes/arvana/front/section-information.php';
