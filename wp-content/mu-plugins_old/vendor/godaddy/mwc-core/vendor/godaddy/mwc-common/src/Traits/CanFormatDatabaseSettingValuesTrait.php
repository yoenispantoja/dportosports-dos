...
trait CanFormatDatabaseSettingValuesTrait
{
    ...
    {
        return $this->formatValueWithCallback($value, $setting, function ($value, SettingContract $setting) {
            return $this->formatSingleValueFromDatabase($value, $setting);
        });
    }
    ...
    {
        return $this->formatValueWithCallback($value, $setting, function ($value, SettingContract $setting) {
            return $this->formatSingleValueForDatabase($value, $setting);
        });
    }
