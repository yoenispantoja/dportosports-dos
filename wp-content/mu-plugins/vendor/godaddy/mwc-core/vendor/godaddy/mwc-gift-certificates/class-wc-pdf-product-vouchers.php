...
class MWC_Gift_Certificates extends Framework\SV_WC_Plugin {
	...
	/** version number */
	public const VERSION = '4.1.5'; // 3.12.6 of PDF Product Vouchers

	/** @var MWC_Gift_Certificates single instance of this plugin */
	protected static $instance;

	/** string the plugin id */
	public const PLUGIN_ID = 'pdf_product_vouchers';

	/** Voucher image thumbnail width */
	public const VOUCHER_IMAGE_THUMB_WIDTH = 100;

	/** int Recommended memory in bytes */
	public const RECOMMENDED_MEMORY = 536870912; // 512MB
