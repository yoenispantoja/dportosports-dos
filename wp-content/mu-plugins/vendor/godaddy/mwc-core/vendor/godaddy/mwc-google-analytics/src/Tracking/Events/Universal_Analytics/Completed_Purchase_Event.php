...
class Completed_Purchase_Event extends Universal_Analytics_Event {
	...
	public function track( $order_id = null ): void {
		 ...
		 * @since 1.1.5
		 *
		 * @see Tracking\Events\GA4\Purchase_Event::track() for same filter reference
		 *
		...
		/**
		 * Filters whether the completed purchase event should be tracked for a given order.
		 *
