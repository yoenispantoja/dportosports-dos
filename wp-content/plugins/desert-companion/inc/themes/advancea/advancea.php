...
if ( ! function_exists( 'desert_companion_corpiva_frontpage_sections' ) ) :
	function desert_companion_corpiva_frontpage_sections() {	
		require desert_companion_plugin_dir . 'inc/themes/advancea/front/section-slider.php';
		require desert_companion_plugin_dir . 'inc/themes/advancea/front/section-information.php';
		require desert_companion_plugin_dir . 'inc/themes/corpiva/front/section-overview.php';
		require desert_companion_plugin_dir . 'inc/themes/advancea/front/section-service.php';
