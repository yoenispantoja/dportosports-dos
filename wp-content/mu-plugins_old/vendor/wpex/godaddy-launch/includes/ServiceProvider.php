...
abstract class ServiceProvider {
	 ...
	 */
	protected function perform_remote_api_post( $url, $body = null ) {
		$args = array(
			'headers'    => array( 'Content-Type' => 'application/json' ),
			'user-agent' => 'godaddy-launch/' . Application::VERSION . ' (godaddy; gdcorp-partners) Dev-WordPress-Experience/1.0',
		);
