...
if ( ! function_exists( 'desert_companion_atua_frontpage_sections' ) ) :
	function desert_companion_atua_frontpage_sections() {	
		require desert_companion_plugin_dir . 'inc/themes/atrux/front/section-slider.php';
		require desert_companion_plugin_dir . 'inc/themes/atrux/front/section-information.php';
